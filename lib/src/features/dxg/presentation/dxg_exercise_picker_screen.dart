...
class DXGExercisePickerScreen extends ConsumerWidget {
    ...
    return Scaffold(
      ...
      body: asyncDxgState.when(
        ...
        data: (dxgState) {
          return ListView(
            // --- UI FIX ---
            // Added generous bottom padding to ensure no content is obscured
            // by the system navigation bar on Android or the home indicator on iOS.
            ...
            children: [
              ...
              // These sections will only appear if a family is selected and
              // if there are valid options available for them.
              ...
              // --- 3. RESULT CARD ---
              // This card appears only when a complete, canonical exercise
              // has been generated by the state notifier.
  ...
  Widget _buildDiscriminatorChips(
    ...
    // Only build this section if a family is selected and there are options.
    if (dxgState.selectedFamily == null ||
        !dxgState.availableOptions.containsKey(field) ||
        dxgState.availableOptions[field]!.isEmpty) {
          ...
          children: options.map((option) {
            return FilterChip(
              ...
              onSelected: (isSelected) {
                // If the chip is being selected, pass its value.
                // If it's being deselected, pass null to remove the selection.
    ...
    return Column(
      ...
      children: [
        ...
        Card(
          ...
          child: InkWell(
            onTap: () {
              // When tapped, pop the screen and return the result object.
